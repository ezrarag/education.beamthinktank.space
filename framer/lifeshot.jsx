 ...
 * height?: any
 * layoutId?: string
 * variant?: 'With text' | 'With logo' // Variant
...
// /:https://framerusercontent.com/modules/aIIMyhiLgasaXERcMfM6/Y4arngtT2Mup2mWdDa3V/oDWaAgYaO.js
...
var cycleOrder = ["Gwyz4rcLj", "D2xGOAkeX"];
var serializationHash = "framer-fipZU";
var variantClassNames = {
	D2xGOAkeX: "framer-v-1krbc50",
	Gwyz4rcLj: "framer-v-bcineh",
};
...
var getProps = ({ description, height, id, image, width, ...props }) => {
	return {
		...props,
		variant:
			humanReadableVariantMap[props.variant] ?? props.variant ?? "Gwyz4rcLj",
		vbkFIfe2b: description ?? props.vbkFIfe2b ?? "Name",
		y8kQccPEM: image ?? props.y8kQccPEM,
	};
};
...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref) {
	...
	const isDisplayed = () => {
		if (baseVariant === "D2xGOAkeX") return false;
		return true;
	};
	const isDisplayed1 = () => {
		if (baseVariant === "D2xGOAkeX") return true;
		return false;
	};
			...
			<Variants animate={variants} initial={false}>
				<Transition value={transition1}>
					...
					>
						{isDisplayed() && (
							<motion.div
								className={"framer-14nichh"}
								data-framer-name={"textinfo"}
								layoutDependency={layoutDependency}
								layoutId={"eTpxDjSrC"}
							>
								<RichText
									__fromCanvasComponent={true}
									className={"framer-4ny0tk"}
									data-framer-name={"name"}
									fonts={["Inter"]}
									layoutDependency={layoutDependency}
									layoutId={"Gwyz4rcLjPM7U8yq88"}
									style={{
										"--extracted-r6o4lv":
...
var css2 = [
	...
	".framer-fipZU.framer-1t5ejh4, .framer-fipZU .framer-1t5ejh4 { display: block; }",
	".framer-fipZU.framer-bcineh { align-content: flex-start; align-items: flex-start; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: 570px; justify-content: flex-end; overflow: hidden; padding: 0px 0px 30px 30px; position: relative; width: 1356px; will-change: var(--framer-will-change-override, transform); }",
	".framer-fipZU .framer-14nichh { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; max-width: 50%; overflow: hidden; padding: 0px; position: relative; width: 100%; z-index: 1; }",
	".framer-fipZU .framer-4ny0tk { flex: none; height: auto; position: relative; white-space: pre; width: auto; z-index: 0; }",
	".framer-fipZU .framer-tuojye { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 107%; justify-content: center; left: calc(50.14749262536875% - 102.72861356932152% / 2); overflow: hidden; padding: 0px; position: absolute; top: calc(49.473684210526336% - 106.84210526315789% / 2); width: 103%; will-change: var(--framer-will-change-override, transform); z-index: 0; }",
	".framer-fipZU .framer-1hmlqll { aspect-ratio: 7.6875 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 23px); position: relative; width: 174px; }",
	"@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-fipZU.framer-bcineh, .framer-fipZU .framer-14nichh, .framer-fipZU .framer-tuojye { gap: 0px; } .framer-fipZU.framer-bcineh > * { margin: 0px; margin-bottom: calc(0px / 2); margin-top: calc(0px / 2); } .framer-fipZU.framer-bcineh > :first-child, .framer-fipZU .framer-14nichh > :first-child { margin-top: 0px; } .framer-fipZU.framer-bcineh > :last-child, .framer-fipZU .framer-14nichh > :last-child { margin-bottom: 0px; } .framer-fipZU .framer-14nichh > * { margin: 0px; margin-bottom: calc(10px / 2); margin-top: calc(10px / 2); } .framer-fipZU .framer-tuojye > * { margin: 0px; margin-left: calc(0px / 2); margin-right: calc(0px / 2); } .framer-fipZU .framer-tuojye > :first-child { margin-left: 0px; } .framer-fipZU .framer-tuojye > :last-child { margin-right: 0px; } }",
	".framer-fipZU.framer-v-1krbc50.framer-bcineh { align-content: center; align-items: center; aspect-ratio: 2.3789473684210525 / 1; height: var(--framer-aspect-ratio-supported, 570px); justify-content: center; padding: 0px; }",
	".framer-fipZU.framer-v-1krbc50 .framer-tuojye { order: 2; }",
	".framer-fipZU.framer-v-1krbc50 .framer-1hmlqll { order: 0; }",
	...css,
];
var FrameroDWaAgYaO = withCSS(Component, css2, "framer-fipZU");
var stdin_default = FrameroDWaAgYaO;
FrameroDWaAgYaO.displayName = "Lifeshot";
FrameroDWaAgYaO.defaultProps = {
	height: 570,
	width: 1356,
};
addPropertyControls(FrameroDWaAgYaO, {
	variant: {
		options: ["Gwyz4rcLj", "D2xGOAkeX"],
		optionTitles: ["With text", "With logo"],
		title: "Variant",
	...
	vbkFIfe2b: {
		defaultValue: "Name",
		description: "Place your image and write a description",
...
/**
 * Renders LifeshotFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
...
var lifeshot_default = ComponentWithRoot;
export { lifeshot_default as default };
