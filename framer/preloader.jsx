 ...
 * height?: any
 * layoutId?: string
 * variant?: 'Slide1 (invisible)' | 'Slide2' | 'Slide3' | 'Slide4' | 'Slide5' // Variant
}} Props
...
// /:https://framerusercontent.com/modules/tZo7V0JwVx9ohq86bGFB/zzDDvJRNgreOmPfPh5u1/hB0TZBwj9.js
...
var serializationHash = "framer-OOjaT";
var variantClassNames = {
	cG2MUxXhA: "framer-v-17wy396",
	inmxqEbMN: "framer-v-ott8fo",
	JikoXPFNJ: "framer-v-pbknlq",
	trwNdV07a: "framer-v-kfb5av",
	UgaGiYdrx: "framer-v-97wzbs",
};
...
var getProps = ({ height, id, width, ...props }) => {
	return {
		...props,
		variant:
			humanReadableVariantMap[props.variant] ?? props.variant ?? "trwNdV07a",
	};
};
...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref) {
	...
	const onAppearl0hrz7 = activeVariantCallback(async (...args) => {
		setVariant("cG2MUxXhA");
	});
	const onAppearynwxww = activeVariantCallback(async (...args) => {
		setVariant("UgaGiYdrx");
	});
	const onAppear10uwslf = activeVariantCallback(async (...args) => {
		await delay(() => setVariant("inmxqEbMN"), 2500);
	});
	const onAppear1s3349u = activeVariantCallback(async (...args) => {
		await delay(() => setVariant("JikoXPFNJ"), 1e3);
	});
	useOnVariantChange(baseVariant, {
		cG2MUxXhA: onAppearynwxww,
		default: onAppearl0hrz7,
		inmxqEbMN: onAppear1s3349u,
		JikoXPFNJ: void 0,
		UgaGiYdrx: onAppear10uwslf,
	});
	const sharedStyleClassNames = [];
	const scopingClassNames = cx(serializationHash, ...sharedStyleClassNames);
	const isDisplayed = () => {
		if (
			["cG2MUxXhA", "UgaGiYdrx", "inmxqEbMN", "JikoXPFNJ"].includes(baseVariant)
		)
			return true;
		return false;
	};
			...
			<Variants animate={variants} initial={false}>
				...
				>
					<motion.div
						...
						data-framer-name={"Slide1 (invisible)"}
						data-highlight={true}
						...
						{...addPropertyOverrides(
							{
								cG2MUxXhA: {
									"data-framer-name": "Slide2",
								},
								inmxqEbMN: {
									"data-framer-name": "Slide4",
								},
								JikoXPFNJ: {
									"data-framer-name": "Slide5",
									"data-highlight": void 0,
								},
								UgaGiYdrx: {
									"data-framer-name": "Slide3",
								},
							},
							baseVariant,
							gestureVariant,
					...
					>
						<ComponentViewportProvider>
							<SmartComponentScopedContainer
								className={"framer-l2x49w-container"}
								isAuthoredByUser={true}
								isModuleExternal={true}
								layoutDependency={layoutDependency}
								layoutId={"xRnA5QOk7-container"}
								nodeId={"xRnA5QOk7"}
						...
						{isDisplayed() && (
							...
							>
								...
								>
									<motion.div
										className={"framer-a2ml35"}
										data-framer-name={"logoline"}
										layoutDependency={layoutDependency}
										layoutId={"rPqQInE8o"}
										style={{
											opacity: 1,
									...
									>
										<motion.div
											className={"framer-u36gn0"}
											data-framer-name={"container1"}
											layoutDependency={layoutDependency}
											layoutId={"sv3YF3pD6"}
											transformTemplate={transformTemplate1}
										>
											...
											>
												<motion.div
													className={"framer-1oz0xu8"}
													data-framer-name={"logo"}
													layoutDependency={layoutDependency}
													layoutId={"FH29846Hw"}
												>
													<SVG
														className={"framer-16xs0l5"}
														data-framer-name={"logo"}
														fill={"rgba(0,0,0,1)"}
														intrinsicHeight={16}
														intrinsicWidth={123}
										...
										<motion.div
											className={"framer-25fezi"}
											data-framer-name={"container2"}
											layoutDependency={layoutDependency}
											layoutId={"SjepfX4SL"}
										>
											<Transition
											...
											>
												...
												>
													...
													<RichText
														__fromCanvasComponent={true}
														className={"framer-zjjjex"}
														fonts={["Inter-SemiBold"]}
														layoutDependency={layoutDependency}
														layoutId={"pg8QcMgcN"}
														style={{
															"--extracted-r6o4lv": "rgb(222, 171, 2)",
															"--framer-paragraph-spacing": "0px",
														}}
														transformTemplate={transformTemplate1}
														verticalAlignment={"top"}
														...
														<React.Fragment>
															<motion.p
																style={{
																	...
																	"--framer-text-alignment": "justify",
																	"--framer-text-color":
																		"var(--extracted-r6o4lv, rgb(222, 171, 2))",
																}}
															>
																{"+"}
															</motion.p>
								...
								<motion.div
									className={"framer-9npjw"}
									data-framer-name={"Whiteblocks"}
									layoutDependency={layoutDependency}
									layoutId={"uukA8aEm4"}
								>
									<Transition
									...
									>
										<motion.div
											className={"framer-1ypoxj4"}
											data-framer-name={"1st"}
											layoutDependency={layoutDependency}
											layoutId={"w2EhL7gEY"}
										>
											<motion.div
												className={"framer-yk2qnf"}
												data-framer-name={"back part1"}
												layoutDependency={layoutDependency}
												layoutId={"tAGtlDIWv"}
												style={{
													backgroundColor:
									...
									>
										<motion.div
											className={"framer-t0meh1"}
											data-framer-name={"2nd"}
											layoutDependency={layoutDependency}
											layoutId={"jWVsxII2E"}
										>
											<motion.div
												className={"framer-pvqgej"}
												data-framer-name={"back part2"}
												layoutDependency={layoutDependency}
												layoutId={"qCvs_NlgC"}
												style={{
													backgroundColor:
									...
									>
										<motion.div
											className={"framer-1f4xn8e"}
											data-framer-name={"3rd"}
											layoutDependency={layoutDependency}
											layoutId={"JMC6sM9zA"}
										>
											<motion.div
												className={"framer-1gw5ibv"}
												data-framer-name={"back part 3"}
												layoutDependency={layoutDependency}
												layoutId={"yPmO1m55A"}
												style={{
													backgroundColor:
...
var css = [
	...
	".framer-OOjaT.framer-2j5t1u, .framer-OOjaT .framer-2j5t1u { display: block; }",
	".framer-OOjaT.framer-kfb5av { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 800px; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 1440px; }",
	".framer-OOjaT .framer-l2x49w-container { flex: none; height: auto; position: relative; width: auto; }",
	".framer-OOjaT .framer-1fgrqsw { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; left: 0px; overflow: visible; padding: 0px; position: absolute; right: 0px; top: 50px; z-index: 10; }",
	".framer-OOjaT .framer-a2ml35 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; left: 50%; min-height: 73px; min-width: 1440px; overflow: visible; padding: 0px; position: absolute; top: 49%; width: min-content; z-index: 1; }",
	".framer-OOjaT .framer-u36gn0 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 66px; justify-content: center; left: 50%; min-width: 263px; overflow: hidden; padding: 0px; position: absolute; top: 4%; width: min-content; z-index: 1; }",
	".framer-OOjaT .framer-1oz0xu8 { align-content: center; align-items: center; bottom: -34px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; left: 0px; min-height: 34px; overflow: visible; padding: 0px; position: absolute; right: 0px; z-index: 1; }",
	".framer-OOjaT .framer-16xs0l5 { flex: none; height: 34px; left: calc(49.80988593155896% - 263px / 2); position: absolute; top: calc(50.00000000000002% - 34px / 2); width: 263px; z-index: 1; }",
	".framer-OOjaT .framer-25fezi { align-content: center; align-items: center; bottom: 1px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; height: 36px; justify-content: space-between; left: calc(50.00000000000002% - 263px / 2); overflow: hidden; padding: 0px; position: absolute; width: 263px; z-index: 1; }",
	".framer-OOjaT .framer-nxjnud { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; left: 0px; min-height: 20px; overflow: visible; padding: 0px; position: absolute; top: -21px; width: 263px; z-index: 1; }",
	".framer-OOjaT .framer-vmhe03 { -webkit-user-select: none; flex: none; height: auto; left: 21%; position: absolute; top: 50%; user-select: none; white-space: pre; width: auto; z-index: 1; }",
	".framer-OOjaT .framer-zjjjex { -webkit-user-select: none; flex: none; height: auto; left: 58%; position: absolute; top: 50%; user-select: none; white-space: pre; width: auto; z-index: 1; }",
	".framer-OOjaT .framer-1yu7n1z { -webkit-user-select: none; flex: none; height: auto; left: 86%; position: absolute; top: 50%; user-select: none; white-space: pre; width: auto; z-index: 1; }",
	".framer-OOjaT .framer-9npjw { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; left: calc(50.00000000000002% - 100% / 2); overflow: hidden; padding: 0px; position: absolute; top: calc(50.00000000000002% - 100vh / 2); width: 100%; z-index: 0; }",
	".framer-OOjaT .framer-1ypoxj4 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }",
	".framer-OOjaT .framer-yk2qnf, .framer-OOjaT .framer-pvqgej, .framer-OOjaT .framer-1gw5ibv { flex: 1 0 0px; height: 100%; overflow: visible; position: relative; width: 1px; }",
	".framer-OOjaT .framer-t0meh1 { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }",
	".framer-OOjaT .framer-1simu2h { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: 16px; justify-content: flex-start; left: -1px; overflow: hidden; padding: 0px; position: absolute; top: -20px; width: 5px; z-index: 1; }",
	".framer-OOjaT .framer-ysr7w0, .framer-OOjaT .framer-116y9x0 { align-content: flex-end; align-items: flex-end; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 100%; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 1px; z-index: 0; }",
	".framer-OOjaT .framer-ean04y { bottom: 7px; flex: none; height: 9px; left: -6px; position: absolute; right: -6px; z-index: 1; }",
	".framer-OOjaT .framer-7bxsgv { align-content: center; align-items: center; bottom: -27px; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: 16px; justify-content: flex-start; overflow: hidden; padding: 0px; position: absolute; right: -3px; width: 5px; z-index: 1; }",
	".framer-OOjaT .framer-wxthlb { flex: none; height: 9px; left: -6px; position: absolute; right: -6px; top: 5px; z-index: 1; }",
	".framer-OOjaT .framer-1f4xn8e { align-content: flex-end; align-items: flex-end; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: calc(var(--framer-viewport-height, 100vh) * 1); justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }",
	".framer-OOjaT.framer-v-17wy396 .framer-1fgrqsw, .framer-OOjaT.framer-v-97wzbs .framer-1fgrqsw, .framer-OOjaT.framer-v-ott8fo .framer-1fgrqsw, .framer-OOjaT.framer-v-pbknlq .framer-1fgrqsw { top: 0px; }",
	".framer-OOjaT.framer-v-97wzbs .framer-1oz0xu8, .framer-OOjaT.framer-v-ott8fo .framer-1oz0xu8, .framer-OOjaT.framer-v-pbknlq .framer-1oz0xu8 { bottom: -1px; }",
	".framer-OOjaT.framer-v-97wzbs .framer-nxjnud, .framer-OOjaT.framer-v-ott8fo .framer-nxjnud, .framer-OOjaT.framer-v-pbknlq .framer-nxjnud { bottom: 0px; top: unset; }",
	".framer-OOjaT.framer-v-97wzbs .framer-1simu2h { height: calc(var(--framer-viewport-height, 100vh) * 0.79); top: 0px; }",
	".framer-OOjaT.framer-v-97wzbs .framer-7bxsgv { bottom: 0px; height: calc(var(--framer-viewport-height, 100vh) * 0.79); }",
	".framer-OOjaT.framer-v-ott8fo .framer-yk2qnf, .framer-OOjaT.framer-v-pbknlq .framer-yk2qnf { flex: none; height: 1px; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: -1px; width: 100%; z-index: 1; }",
	".framer-OOjaT.framer-v-ott8fo .framer-pvqgej { flex: none; height: 1px; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: calc(49.87500000000003% - 1px / 2); width: 100%; z-index: 1; }",
	".framer-OOjaT.framer-v-ott8fo .framer-1gw5ibv, .framer-OOjaT.framer-v-pbknlq .framer-1gw5ibv { bottom: -1px; flex: none; height: 1px; left: calc(50.00000000000002% - 100% / 2); position: absolute; width: 100%; z-index: 1; }",
	".framer-OOjaT.framer-v-pbknlq .framer-pvqgej { flex: none; height: 1px; left: calc(50.00000000000002% - 61px / 2); position: absolute; top: calc(49.87500000000003% - 1px / 2); width: 61px; z-index: 1; }",
];
var FramerhB0TZBwj9 = withCSS(Component, css, "framer-OOjaT");
var stdin_default = FramerhB0TZBwj9;
FramerhB0TZBwj9.displayName = "Preloader";
FramerhB0TZBwj9.defaultProps = {
	height: 800,
	width: 1440,
};
addPropertyControls2(FramerhB0TZBwj9, {
	variant: {
		options: ["trwNdV07a", "cG2MUxXhA", "UgaGiYdrx", "inmxqEbMN", "JikoXPFNJ"],
		optionTitles: [
			"Slide1 (invisible)",
			"Slide2",
			"Slide3",
...
/**
 * Renders PreloaderFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
...
var preloader_default = ComponentWithRoot;
export { preloader_default as default };
